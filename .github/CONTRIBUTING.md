...
Fourteen of the 41 have no such header — the outputs that are not Markdown:
...
`.ai-rulez-generated.json` is the authoritative list — 41 paths today. If a file is in
