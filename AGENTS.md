...
(`gha-latest-runs.sh`, `hcp-apply-scope.sh`, `hcp-bootstrap-workspaces.sh`,
`hcp-current-plan.sh`, `leaf-cloud.sh`, `status-check-context.sh`), and the YAML workflow templates
