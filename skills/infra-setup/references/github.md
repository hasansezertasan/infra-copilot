...
This repo's managed repos (`managed_repos` in `.claude/infra-copilot.local.md` — e.g.
...
is a locked decision — see this repo's root `CLAUDE.md` locked-decisions table.
