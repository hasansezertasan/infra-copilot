...
Content-Hash: blake3:90b37ac05b2b8f33c69f311c1e15f320be8ac2f50e333432a479c013f7068a18
...
state_backend: gcs             # Terraform backend type: gcs | s3 | azurerm | cos | oss | ...
state_bucket: <string>         # bucket name for state files
...
state_region: ""               # region for S3/azurerm; GCS uses bucket location
# ... common fields ...
---
```
...
never their values. The schema differs by backend mode:
