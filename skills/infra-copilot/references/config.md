...
Content-Hash: blake3:04aeaebccbb5690e223e30ccc7de4259d9a75c2e4e5543f8126e08ac7f7de923
...
4. If present, export the shell vars the checks reference:
   ...
   `TERRAFORM_VERSION` comes from the exact committed repository file, not the active
   mise environment. Refuse to continue if it is empty or not an exact version.
