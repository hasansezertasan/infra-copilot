...
Before any resume scan, read `.claude/infra-copilot.local.md` from the current repo and
...
offer to scaffold from [`infra-copilot.local.md.example`](infra-copilot.local.md.example),
